...
export default function Home() {
  ...
  <h1 className='text-4xl font-bold tracking-tight text-gray-900 sm:text-6x1'>Your Marketplace For High-Quality{'-'}
    <span className='text-blue-600'>digital assets</span>
    .
  </h1>
  <p className='mt-6 text -lg max-w-prose text-muted-foreground'>
    Welcome to DigitalHippo. Every asset on 
